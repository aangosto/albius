...
│   │   │   ├── components/{auth,layout,tenants,ui}/  ← ProtectedRoute + Sidebar/Topbar + 4 componentes tenants/ + 10 shadcn ui (button, card pre-B10; input, label, dialog, table, select, checkbox, alert, badge en B10)
