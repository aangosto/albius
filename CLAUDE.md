...
- `TODO[web-bundle-splitting]` — **PRIORITARIO** (promovido de baja en Bloque 7).
  ...
  Estado actual:
  - Bundle principal: 930.84 kB (gzip 256.43 kB) tras Bloque 10 (+126 kB por grafo Dialog/Select de Radix umbrella vs 804 kB tras Bloque 7; histórico: 615 kB tras Bloque 6, +189 kB en B7 por `firebase/functions` SDK + deps transitivas gRPC/Protobuf)
